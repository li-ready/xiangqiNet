...
public class cameraInputTest extends GestureDetector {
    ...
    protected static class CameraGestureListener extends GestureAdapter {
        public cameraInputTest controller;
    ...
    protected cameraInputTest(final CameraGestureListener gestureListener, final Camera camera) {
    ...
    public cameraInputTest(final Camera camera) {
    ...
    /** Sets the CameraInputTests' control inversion.
